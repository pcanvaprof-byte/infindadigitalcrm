...
import { OnboardingView } from "@/modules/operacoes/views/OnboardingView";

export const Route = createFileRoute("/operacoes/clientes/$id/onboarding")({
  ssr: false,
  component: Page,
});
...
function Page() {
  ...
  return <OnboardingView clientId={opClientId} />;
}